...
public class CameraSource {
  ...
  public synchronized com.etisalat.test.CameraSource start() throws IOException {
    if (camera != null) {
      return this;
    }
   ...
   */
  @RequiresPermission(Manifest.permission.CAMERA)
  public synchronized com.etisalat.test.CameraSource start(SurfaceHolder surfaceHolder) throws IOException {
    if (camera != null) {
      return this;
    }
