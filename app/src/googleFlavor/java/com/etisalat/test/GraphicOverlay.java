...
public class GraphicOverlay extends View {
   ...
   * instances to the overlay using {@link com.etisalat.test.GraphicOverlay#add(Graphic)}.
   */
  public abstract static class Graphic {
    private com.etisalat.test.GraphicOverlay overlay;

    public Graphic(com.etisalat.test.GraphicOverlay overlay) {
