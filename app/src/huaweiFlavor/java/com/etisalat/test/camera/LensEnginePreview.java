...
public class LensEnginePreview extends ViewGroup {
    ...
    /**
     * Determines whether the camera preview frame and
     * detection result display frame are synchronous or asynchronous.
     */
    ...
    protected void onLayout(boolean changed, int left, int top, int right, int bottom) {
        ...
        // When the phone is in portrait orientation, the width and
        // height dimensions are interchangeable.
        if (this.isVertical()) {
            int tmp = width;
            width = height;
            height = tmp;
        ...
        for (int i = 0; i < this.getChildCount(); ++i) {
            // One dimension will be cropped. We shift child over
            // or up by this offset and adjust
